...
#    Updated: 2015/01/12 20:04:28 by ql-eilde         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = ft_minishell1

SRC = minishell1.c gnl/get_next_line.c builtins.c other_functions1.c \
	  other_functions2.c other_functions3.c

OBJ = minishell1.o get_next_line.o builtins.o other_functions1.o \
...
$(NAME):
	...
	@gcc $(FLAGS) -I libft/ -c minishell1.c
